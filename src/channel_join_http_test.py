'''
Frontend tests for channel_join function
'''
...
def test_valid_channel_join_test_web(url):
    '''Valid case: valid use of channel_join, all inputs valid'''
...
def test_invalid_channelid_channel_join_web(url):
...
def test_private_channel_leave_web(url):
    '''Invalid case: the user is requesting to join a private channel is not a global owner'''
    requests.delete(url + 'clear')
